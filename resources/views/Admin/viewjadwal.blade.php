                  ...
                  <div class="table-responsive">
                    ...
                    <td>Aksi</td>
                      ...
                      @foreach($data_kelas->mapel as $ml)
                            ...
                            <td >
                            <a href="/Admin/{{$data_kelas->id}}/{{$ml->id}}/hapusjadwal" class="button " onclick="return confirm('Apakah anda yakin untuk menghapus data ')">Hapus Jadwal</a>
                            </td>
                        </tr>
                        @endforeach
                      </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width:535px;">
            ...
            <div class="modal-body">
                <form action="/Admin/{{$data_kelas->id}}/addjadwal" method="POST">
                    {{csrf_field()}}
                    <div class="mb-3">
